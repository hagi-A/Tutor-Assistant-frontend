...
const Dashboard = ({ isOpen, toggleChat }) => {
  ...
  useEffect(() => {
    setSocket(io("http://127.0.0.1:4002"));
  }, []);
  ...
  useEffect(() => {
    ...
    const fetchConversations = async () => {
      const res = await fetch(
        `http://127.0.0.1:4002/api/conversations/${loggedInUser?.id}`,
        {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      const res = await fetch(`http://127.0.0.1:4002/api/users/${user?.id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchMessages = async (conversationId, receiver) => {
    const res = await fetch(
      `http://127.0.0.1:4002/api/message/${conversationId}?senderId=${user?.id}&&receiverId=${receiver?.receiverId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  const sendMessage = async (e) => {
    ...
    const res = await fetch(`http://127.0.0.1:4002/api/message`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      ...
      <div className="max-w-lg w-full bg-white p-4 rounded shadow-lg ">
        <div className="flex items-center my-8 mx-14">
          ...
          <div className="ml-8">
            ...
            <button
              className="ml-2 p-2 bg-blue-500 text-white rounded float-right"
              onClick={toggleChat}
            >
              Close
            </button>
