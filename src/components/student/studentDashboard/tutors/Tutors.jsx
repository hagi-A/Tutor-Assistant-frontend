                          ...
                          >
                            <Link to={"/classroom"}>
                              <div className="p-4  rounded-lg bg-slate-50 border hover:border-[#745B83]">
                                ...
                                <button className="bg-[#745B83] text-white rounded-lg w-full h-10 mt-4 cursor-pointer transition duration-300 hover:bg-transparent border  hover:border-[#745B83] hover:text-[#745B83]">
